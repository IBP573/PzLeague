...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/pzleague<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/pzleague) Block Dash 1v1",
      descriptionKey: "Practice your skills in the Pz League TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/pzleague) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the pzleague TournamentX! mode!",
